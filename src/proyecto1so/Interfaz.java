...
//------------------------------------------------------------------------------
    ...
    public void Go() {
		...
		this.textarea3.setWrapStyleWord(true);
                ...
                this.textarea3.setForeground(Color.black);
		...
		this.textarea4.setWrapStyleWord(true);
                ...
                this.textarea4.setForeground(Color.black);
                this.textarea4.setBackground(Color.white);
		...
		this.textarea5.setWrapStyleWord(true);
                ...
                this.textarea5.setBackground(Color.white);
		...
		this.textarea6.setWrapStyleWord(true);
                ...
                this.textarea6.setBackground(Color.white);
		...
		this.nro_dias_programa.setForeground(Color.black);
                this.nro_dias_programa.setBackground(Color.white);
		...
		this.textarea7.setForeground(Color.black);
                this.textarea7.setBackground(Color.white);
		...
		this.cronometrador.setForeground(Color.black);
                this.cronometrador.setBackground(Color.white);
		...
		this.cronometrador.setWrapStyleWord(true);
                ...
                this.unidades_finales.setBackground(Color.white);
		...
		this.unidades_finales.setWrapStyleWord(true);
                ...
                this.textarea8.setBackground(Color.white);
